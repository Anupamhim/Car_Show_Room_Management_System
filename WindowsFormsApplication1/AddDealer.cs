...
namespace WindowsFormsApplication1
{
    public partial class AddDealer : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            ml.addDealer(this.id,this.fName,this.lName,this.email,this.mobile,this.address,this.brand,this.company,this.dealerImage);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dealerImage1.Image = image;
            dealerImage1.Height = image.Height;
            dealerImage1.Width = image.Width;
